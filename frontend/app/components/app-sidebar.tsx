...
const NAV: NavItem[] = [
  ...
  { title: "Register", to: "/register", icon: ClipboardCheckIcon, show: (me) => me.permissions.includes("reports:read") },
  { title: "Classes", to: "/classes", icon: LayersIcon, show: (me) => me.permissions.includes("classes:read") },
  { title: "Students", to: "/students", icon: GraduationCapIcon, show: (me) => me.permissions.includes("students:read") },
  { title: "Sessions", to: "/sessions", icon: CalendarClockIcon, show: (me) => me.permissions.includes("sessions:manage") },
  { title: "Staff", to: "/users", icon: UsersIcon, show: (me) => me.permissions.includes("users:read") },
  {
